...
async function getPokemonList(){
    const repsonse = await fetch("https://pokeapi.co/api/v2/pokemon/?limit=35");
...
function createCard(pokemon){
    ...
    <img src="${pokemon.sprites.other.dream_world.front_default}" class="card-img-top" width="150" height="150" alt="${pokemon.name}">
    <div class="card-body">
        <h3 class="card-title" style="text-transform: capitalize;">${pokemon.name}</h3>
        <div class="badge bg-warning text-dark">Height: ${pokemon.height}</div>
